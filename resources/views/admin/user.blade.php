                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-inline-flex align-items-center">
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form action="{{ route('admin.destroy', $user->id) }}" method="POST" class="delete-form d-inline mr-1" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini?');">
                                                        @csrf
                                                        @method('DELETE')
