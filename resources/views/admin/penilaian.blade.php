                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.destroyPenilaian', $kinerja->id) }}" method="POST" class="delete-form d-inline">
                                                @csrf
                                                @method('DELETE')
...
<script>
    $(document).ready(function() {
        ...
        $('#editNilaiModal').on('show.bs.modal', function(event) {
            ...
            // Update form action
            var actionUrl = "{{ route('admin.updatePenilaian', ':id') }}".replace(':id', userId);
