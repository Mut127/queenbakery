                            ...
                            <div class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form id="addUserForm" method="post" action="{{ route('owner.store') }}" enctype="multipart/form-data">
                                            @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-inline-flex align-items-center">
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form action="{{ route('owner.destroy', $user->id) }}" method="POST" class="delete-form mt-2" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini?');">
                                                        @csrf
                                                        @method('DELETE')
